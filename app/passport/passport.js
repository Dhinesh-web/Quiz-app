...
module.exports = function(app, passport) {
    ...
    passport.use(new FacebookStrategy({
            clientID: '2499692293586640', // Replace with your Facebook Developer App client ID
            clientSecret: '2179f7693df2c602c6464c5357aeff4c', // Replace with your Facebook Developer client secret
    ...
    passport.use(new GoogleStrategy({
            clientID: '693167561281-m9itto4q2ptf5v0a1s83ki5coh9inhc8.apps.googleusercontent.com', // Replace with your Google Developer App client ID
            clientSecret: 'U14VQ1Kz6TXRJahJTT5lJuJB', // Replace with your Google Developer App client ID
            callbackURL: "http://localhost:8081/auth/google/callback" // Replace with your Google Developer App callback URL
        },
        function(accessToken, refreshToken, profile, done) {
            User.findOne({ email: profile.emails[0].value }).select('username active password email').exec(function(err, user) {
                if (err) done(err);
