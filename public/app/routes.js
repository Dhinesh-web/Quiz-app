...
.config(function($routeProvider, $locationProvider) {
    ...
    .when('/success', {
        templateUrl: 'temp/success.html'
    })
    .when('/failure', {
        templateUrl: 'temp/failure.html'
    })
    .when('/size', {
        templateUrl: 'temp/size.html'
    })
    .when('/nil', {
        templateUrl: 'temp/nil.html'
    })
    .when('/reject', {
        templateUrl: 'temp/reject.html'
    })
    .when('/reject', {
        templateUrl: 'temp/reject.html'
    })
    .when('/failed', {
        templateUrl: 'temp/failed.html'
    })
    .when('/wrong', {
        templateUrl: 'temp/wrong.html'
    })
    // .when('/test', {
    ...
    .when('/file', {
        templateUrl: 'app/views/pages/users/file.html',
        authenticated: true
    })
    .when('/loan', {
        templateUrl: 'app/views/pages/users/loan.html',
        authenticated: true
    })
    .when('/secure', {
        templateUrl: 'app/views/pages/users/secure.html',
        authenticated: true,
